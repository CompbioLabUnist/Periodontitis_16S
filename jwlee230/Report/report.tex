    ...
    \section{Results}
        ...
        \subsection{Random Forest Classifier with Every Class}
            ...
            \begin{figure}[p]
                \centering
                $\begin{array}{cc}
                    \includegraphics[width=0.4 \linewidth]{figures/RandomForest/ANCOM.DADA2.gg/Feature_0.png}
                    &
                    \includegraphics[width=0.4 \linewidth]{figures/RandomForest/ANCOM.DADA2.gg/Feature_1.png}
                    \\
                    \mbox{(a) \textit{Actinomyce}} & \mbox{(b) \textit{Filifactor}} \\
                \end{array}$
                \caption{Most and Second Most Important Features with DADA2 and GG}
                \label{fig:RF-every-important-DADA2-gg}
            \end{figure}

            \begin{table}[p]
                \centering
                \caption{Taxa with DADA2 and SILVA Ordered by Random Forest}
                \label{tb:RF-every-dada2-silva}
            ...
            \begin{figure}[p]
                ...
                \label{fig:RF-every-metrics-DADA2-silva}
            \end{figure}

            \begin{figure}[p]
                \centering
                $\begin{array}{cc}
                    \includegraphics[width=0.4 \linewidth]{figures/RandomForest/ANCOM.DADA2.silva/Feature_0.png}
                    &
                    \includegraphics[width=0.4 \linewidth]{figures/RandomForest/ANCOM.DADA2.silva/Feature_1.png}
                    \\
                    \mbox{(a) \textit{Actinomyces}} & \mbox{(b) \textit{Schaalia odontolytica}} \\
                \end{array}$
                \caption{Most and Second Most Important Features with DADA2 and SILVA}
                \label{fig:RF-every-important-DADA2-silva}
            \end{figure}
            ...
            \begin{table}[p]
                ...
                \csvreader[tabular=cp{10cm}l, no head, column count=3, table head=\hline, late after first line=\\\hline, table foot=\hline]{csv/RandomForest/whole-DADA2-homd.txt}{}{\csvlinetotablerow}
            \end{table}
            ...
            \begin{table}[p]
                \centering
                \caption{Taxa with Deblur and GG Ordered by Random Forest}
                \label{tb:RF-every-deblur-gg}
            ...
            \begin{figure}[p]
                ...
                \caption{Metrics by Feature Count with Deblur and GG}
                \label{fig:RF-every-metrics-Deblur-gg}
            \end{figure}

            \begin{figure}[p]
                \centering
                $\begin{array}{cc}
                    \includegraphics[width=0.4 \linewidth]{figures/RandomForest/ANCOM.Deblur.gg/Feature_0.png}
                    &
                    \includegraphics[width=0.4 \linewidth]{figures/RandomForest/ANCOM.Deblur.gg/Feature_1.png}
                    \\
                    \mbox{(a) \textit{Treponema}} & \mbox{(b) \textit{Filifactor}} \\
                \end{array}$
                \caption{Most and Second Most Important Features with Deblur and GG}
                \label{fig:RF-every-important-Deblur-gg}
            \end{figure}
            ...
            \begin{figure}[p]
                \centering
                $\begin{array}{cc}
                    \includegraphics[width=0.4 \linewidth]{figures/RandomForest/ANCOM.Deblur.silva/Feature_0.png}
                    &
                    \includegraphics[width=0.4 \linewidth]{figures/RandomForest/ANCOM.Deblur.silva/Feature_1.png}
                    \\
                    \mbox{(a) \textit{Porphyromonas gingivalis}} & \mbox{(b) \textit{Treponema uncultured bacterium}} \\
                \end{array}$
                \caption{Most and Second Most Important Features with Deblur and SILVA}
                \label{fig:RF-every-important-Deblur-silva}
            \end{figure}
        ...
        \subsection{Random Forest Classifier with Merging (Healthy+Early) Classes}
            ...
            \begin{table}[p]
                ...
                \csvreader[tabular=cp{10cm}l, no head, column count=3, table head=\hline, late after first line=\\\hline, table foot=\hline]{csv/RandomForest/one-DADA2-gg.txt}{}{\csvlinetotablerow}
            \end{table}
            ...
            \begin{figure}[p]
                \centering
                $\begin{array}{cc}
                    \includegraphics[width=0.4 \linewidth]{figures/RandomForest/one.DADA2.gg/Feature_0.png}
                    &
                ...
                \end{array}$
                \caption{Most and Second Most Important Features with DADA2 and GG for Merging (Healthy+Early) Classes}
                \label{fig:RF-HE-important-DADA2-gg}
            \end{figure}

            \begin{table}[p]
                \centering
                \caption{Taxa with DADA2 and SILVA Ordered by Random Forest for Merging (Healthy+Early) Classes}
                \label{tb:RF-HE-DADA2-silva}

                \csvreader[tabular=cp{10cm}l, no head, column count=3, table head=\hline, late after first line=\\\hline, table foot=\hline]{csv/RandomForest/one-DADA2-silva.txt}{}{\csvlinetotablerow}
            \end{table}

            \begin{figure}[p]
                \centering
                \includegraphics[width=0.7 \linewidth]{figures/RandomForest/one.DADA2.silva/metrics.png}
                \caption{Metrics by Feature Count with DADA2 and SILVA for Merging (Healthy+Early) Classes}
                \label{fig:RF-HE-metrics-DADA2-silva}
            \end{figure}

            \begin{figure}[p]
                \centering
                $\begin{array}{cc}
                    \includegraphics[width=0.4 \linewidth]{figures/RandomForest/one.DADA2.silva/Feature_0.png}
                    &
                    \includegraphics[width=0.4 \linewidth]{figures/RandomForest/one.DADA2.silva/Feature_1.png}
                    \\
                    \mbox{(a) \textit{Actinomyces}} & \mbox{(b) \textit{Porphyromonas gingivalis}} \\
                \end{array}$
                \caption{Most and Second Most Important Features with DADA2 and SILVA for Merging (Healthy+Early) Classes}
                \label{fig:RF-HE-important-DADA2-silva}
            \end{figure}
            ...
            \begin{table}[p]
                \centering
                \caption{Taxa with Deblur and GG Ordered by Random Forest for Merging (Healthy+Early) Classes}
                \label{tb:RF-HE-Deblur-gg}

                \csvreader[tabular=cp{10cm}l, no head, column count=3, table head=\hline, late after first line=\\\hline, table foot=\hline]{csv/RandomForest/one-Deblur-gg.txt}{}{\csvlinetotablerow}
            \end{table}

            \begin{figure}[p]
                \centering
                \includegraphics[width=0.7 \linewidth]{figures/RandomForest/one.Deblur.gg/metrics.png}
                \caption{Metrics by Feature Count with Deblur and GG for Merging (Healthy+Early) Classes}
                \label{fig:RF-HE-metrics-Deblur-gg}
            \end{figure}

            \begin{figure}[p]
                \centering
                $\begin{array}{cc}
                    \includegraphics[width=0.4 \linewidth]{figures/RandomForest/one.Deblur.gg/Feature_0.png}
                    &
                    \includegraphics[width=0.4 \linewidth]{figures/RandomForest/one.Deblur.gg/Feature_1.png}
                    \\
                    \mbox{(a) \textit{Treponema}} & \mbox{(b) \textit{Filifactor}} \\
                \end{array}$
                \caption{Most and Second Most Important Features with Deblur and GG for Merging (Healthy+Early) Classes}
                \label{fig:RF-HE-important-Deblur-gg}
            \end{figure}
            ...
            \begin{table}[p]
                ...
                \csvreader[tabular=cp{10cm}l, no head, column count=3, table head=\hline, late after first line=\\\hline, table foot=\hline]{csv/RandomForest/one-Deblur-silva.txt}{}{\csvlinetotablerow}
            \end{table}
            ...
            \begin{figure}[p]
                \centering
                $\begin{array}{cc}
                    \includegraphics[width=0.4 \linewidth]{figures/RandomForest/one.Deblur.silva/Feature_0.png}
                    &
                    \includegraphics[width=0.4 \linewidth]{figures/RandomForest/one.Deblur.silva/Feature_1.png}
                    \\
                    \mbox{(a) \textit{Porphyromonas gingivalis}} & \mbox{(b) \textit{Treponema denticola}} \\
                \end{array}$
                \caption{Most and Second Most Important Features with Deblur and SILVA for Merging (Healthy+Early) Classes}
                \label{fig:RF-HE-important-Deblur-silva}
            \end{figure}

            \begin{table}[p]
                \centering
                \caption{Taxa with Deblur and HOMD Ordered by Random Forest for Merging (Healthy+Early) Classes}
                \label{tb:RF-HE-Deblur-homd}

                \csvreader[tabular=cp{10cm}l, no head, column count=3, table head=\hline, late after first line=\\\hline, table foot=\hline]{csv/RandomForest/one-Deblur-homd.txt}{}{\csvlinetotablerow}
            \end{table}

            \begin{figure}[p]
                \centering
                \includegraphics[width=0.7 \linewidth]{figures/RandomForest/one.Deblur.homd/metrics.png}
                \caption{Metrics by Feature Count with Deblur and HOMD for Merging (Healthy+Early) Classes}
                \label{fig:RF-HE-metrics-Deblur-homd}
            \end{figure}

            \begin{figure}[p]
                \centering
                $\begin{array}{cc}
                    \includegraphics[width=0.4 \linewidth]{figures/RandomForest/one.Deblur.homd/Feature_0.png}
                    &
                    \includegraphics[width=0.4 \linewidth]{figures/RandomForest/one.Deblur.homd/Feature_1.png}
                    \\
                    \mbox{(a) \textit{Porphyromonas gingivalis}} & \mbox{(b) \textit{Actinomyces}} \\
                \end{array}$
                \caption{Most and Second Most Important Features with Deblur and HOMD for Merging (Healthy+Early) Classes}
                \label{fig:RF-HE-important-Deblur-homd}
            \end{figure}
