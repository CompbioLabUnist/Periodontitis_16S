    ...
    \section{Results}
        ...
        \subsection{Random Forest Classifier with Every Class}
            \subsubsection{DADA2 + Greengenes}
                ...
                \begin{figure}[p]
                    \centering
                    \includegraphics[width=0.8 \linewidth]{figures/RandomForest/ANCOM.DADA2.gg/importances.png}
            ...
            \subsubsection{DADA2 + SILVA}
                ...
                \begin{figure}[p]
                    \centering
                    \includegraphics[width=0.8 \linewidth]{figures/RandomForest/ANCOM.DADA2.silva/importances.png}
            ...
            \subsubsection{Deblur + Greengenes}
                ...
                \begin{figure}[p]
                    \centering
                    \includegraphics[width=0.8 \linewidth]{figures/RandomForest/ANCOM.Deblur.gg/importances.png}
            ...
            \subsubsection{Deblur + SILVA}
                ...
                \begin{figure}[p]
                    \centering
                    \includegraphics[width=0.8 \linewidth]{figures/RandomForest/ANCOM.Deblur.silva/importances.png}
