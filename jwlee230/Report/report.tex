    ...
    \section{Results}
        ...
        \subsection{Random Forest Classifier with Every Class}
            ...
            \subsubsection{DADA2 + Greengenes}
                ...
                \begin{figure}[p]
                    \centering
                    \includegraphics[width=0.7 \linewidth]{figures/RandomForest/ANCOM.DADA2.gg/accuracy.png}
                    \caption{Accuracy by Feature Count with DADA2 and Greengenes}
                    \label{fig:ACC-DADA2-gg}
                \end{figure}

                \begin{figure}[p]
                    \centering
                    \includegraphics[width=0.7 \linewidth]{figures/RandomForest/ANCOM.DADA2.gg/balanced_accuracy.png}
                    \caption{Balanced Accuracy by Feature Count with DADA2 and Greengenes}
                    \label{fig:BA-DADA2-gg}
                \end{figure}
            ...
            \subsubsection{DADA2 + SILVA}
                ...
                \begin{figure}[p]
                    \centering
                    \includegraphics[width=0.7 \linewidth]{figures/RandomForest/ANCOM.DADA2.silva/accuracy.png}
                    \caption{Accuracy by Feature Count with DADA2 and SILVA}
                    \label{fig:ACC-DADA2-silva}
                \end{figure}

                \begin{figure}[p]
                    \centering
                    \includegraphics[width=0.7 \linewidth]{figures/RandomForest/ANCOM.DADA2.silva/balanced_accuracy.png}
                    \caption{Balanced Accuracy by Feature Count with DADA2 and SILVA}
                    \label{fig:BA-DADA2-silva}
                \end{figure}
            ...
            \subsubsection{Deblur + Greengenes}
                ...
                \begin{figure}[p]
                    \centering
                    \includegraphics[width=0.7 \linewidth]{figures/RandomForest/ANCOM.Deblur.gg/accuracy.png}
                    \caption{Accuracy by Feature Count with Deblur and Greengenes}
                    \label{fig:ACC-Deblur-gg}
                \end{figure}

                \begin{figure}[p]
                    \centering
                    \includegraphics[width=0.7 \linewidth]{figures/RandomForest/ANCOM.Deblur.gg/balanced_accuracy.png}
                    \caption{Balanced Accuracy by Feature Count with Deblur and Greengenes}
                    \label{fig:BA-Deblur-gg}
                \end{figure}
            ...
            \subsubsection{Deblur + SILVA}
                ...
                \begin{figure}[p]
                    \centering
                    \includegraphics[width=0.7 \linewidth]{figures/RandomForest/ANCOM.Deblur.silva/accuracy.png}
                    \caption{Accuracy by Feature Count with Deblur and SILVA}
                    \label{fig:ACC-Deblur-silva}
                \end{figure}

                \begin{figure}[p]
                    \centering
                    \includegraphics[width=0.7 \linewidth]{figures/RandomForest/ANCOM.Deblur.silva/balanced_accuracy.png}
                    \caption{Balanced Accuracy by Feature Count with Deblur and SILVA}
                    \label{fig:BA-Deblur-silva}
                \end{figure}
