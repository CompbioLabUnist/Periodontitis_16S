...
\begin{document}
    ...
    \section{Results}
        ...
        \subsection{t-SNE Plot with ANCOM Selected}

            \begin{figure}[p]
                \centering
                \includegraphics[width=0.6 \linewidth]{figures/tSNE/ANCOM/ANCOM.DADA2.gg.png}
                \caption{t-SNE Plot with ANCOM Selected from DADA2 and Greengenes}
            ...
            \begin{figure}[p]
                ...
                \caption{t-SNE Plot with ANCOM Selected from DADA2 and SILVA}
            ...
            \begin{figure}[p]
                ...
                \caption{t-SNE Plot with ANCOM Selected from Deblur and Greengenes}
            ...
            \begin{figure}[p]
                ...
                \caption{t-SNE Plot with ANCOM Selected from Deblur and SILVA}
