    ...
    \section{Results}
        ...
        \subsection{Random Forest Classifier with Every Class}
            ...
            \begin{figure}[p]
                ...
                \label{fig:RF-whole-metrics-DADA2-gg}
            \end{figure}
            ...
            \begin{figure}[p]
                ...
                \label{fig:RF-whole-important-DADA2-gg}
            \end{figure}
            ...
            \begin{figure}[p]
                ...
                \label{fig:RF-whole-metrics-DADA2-silva}
            \end{figure}
            ...
            \begin{figure}[p]
                ...
                \label{fig:RF-whole-important-DADA2-silva}
            \end{figure}
            ...
            \begin{figure}[p]
                ...
                \label{fig:RF-whole-metrics-DADA2-homd}
            \end{figure}
            ...
            \begin{figure}[p]
                ...
                \label{fig:RF-whole-important-DADA2-homd}
            \end{figure}
            ...
            \begin{figure}[p]
                ...
                \label{fig:RF-whole-metrics-Deblur-gg}
            \end{figure}
            ...
            \begin{figure}[p]
                ...
                \label{fig:RF-whole-important-Deblur-gg}
            \end{figure}
            ...
            \begin{figure}[p]
                ...
                \label{fig:RF-whole-metrics-Deblur-silva}
            \end{figure}
            ...
            \begin{figure}[p]
                ...
                \label{fig:RF-whole-important-Deblur-silva}
            \end{figure}

            \begin{table}[p]
                \centering
                \caption{Taxa with Deblur and HOMD Ordered by Random Forest}
                \label{tb:RF-whole-Deblur-homd}
            ...
            \begin{figure}[p]
                ...
                \label{fig:RF-whole-metrics-Deblur-homd}
            \end{figure}
            ...
            \begin{figure}[p]
                ...
                \label{fig:RF-whole-important-Deblur-homd}
            \end{figure}

        \subsection{Random Forest Classifier with Merging (Healthy+Early) Classes}

        \subsection{Random Forest Classifier with Merging (Moderate+Sever) Classes}
