...
\begin{document}
    \begin{tikzpicture}
        ...
        \node[block, right=1cm of 00] (01) {Order Features by Importance};
        \path[line] (00) -- (01);

        \node[block, right=1cm of 01] (02) {Divide Train and Test set};
        \path[line] (01) -- (02);

        \node[block, below=1cm of 00] (03) {Decide the Best Features};
        \path[line] (02) to[|-|] (03);

        \node[block, right=1cm of 03] (04) {Get Final Classification Result};
        \path[line] (03) -- (04);

        \node[block, right=1cm of 04] (05) {Aggregate Confusion Matrices};
        \path[line] (04) -- (05);
    \end{tikzpicture}
\end{document}