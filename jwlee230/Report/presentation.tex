...
\begin{document}
    ...
    \begin{frame}[allowframebreaks]
        ...
        \begin{figure}
            ...
            \end{array}$
            \caption{Bray Curtis Distance with DADA2 ($p < 0.001$)}
        \end{figure}
        ...
        \begin{figure}
            $\begin{array}{cc}
                ...
                \mbox{(c) Moderate} & \mbox{(d) Severe} \\
            \end{array}$
            \caption{Jaccard Distance with DADA2 ($p < 0.001$)}
        \end{figure}
        ...
        \begin{figure}
            $\begin{array}{cc}
                ...
                \mbox{(c) Moderate} & \mbox{(d) Severe} \\
            \end{array}$
            \caption{Unweighted Unifrac Distance with DADA2 ($p < 0.001$)}
        \end{figure}
        ...
        \begin{figure}
            $\begin{array}{cc}
                ...
                \mbox{(c) Moderate} & \mbox{(d) Severe} \\
            \end{array}$
            \caption{Weighted Unifrac Distance with DADA2 ($p < 0.001$)}
        \end{figure}
    \end{frame}
