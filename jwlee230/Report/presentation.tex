...
\begin{document}
   ...
   \end{frame}
    ...
    \begin{frame}
        ...
        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.2 \linewidth]{figures/AlphaDiversity/DADA2/DADA2.evenness.pdf}
                &
                \includegraphics[width=0.2 \linewidth]{figures/AlphaDiversity/DADA2/DADA2.faith_pd.pdf}
                \\
                \mbox{(a) Evenness ($p < 0.01$)} & \mbox{(b) Faith PD ($p < 10^{-6}$)} \\

                \includegraphics[width=0.2 \linewidth]{figures/AlphaDiversity/DADA2/DADA2.observed_features.pdf}
                &
                \includegraphics[width=0.2 \linewidth]{figures/AlphaDiversity/DADA2/DADA2.shannon.pdf}
                \\
    ...
    \begin{frame}[allowframebreaks]
        ...
        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{figures/BetaDiversity/DADA2.bray_curtis.pdf}
                &
                \includegraphics[width=0.4 \linewidth]{figures/BetaDiversity/DADA2.jaccard.pdf}
                \\
        ...
        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{figures/BetaDiversity/DADA2.unweighted_unifrac.pdf}
                &
                \includegraphics[width=0.4 \linewidth]{figures/BetaDiversity/DADA2.weighted_unifrac.pdf}
                \\
    ...
    \begin{frame}
        ...
        \begin{figure}
            \includegraphics[width=0.5 \linewidth]{figures/Act-Pg/2D.DADA2.homd.pdf}
