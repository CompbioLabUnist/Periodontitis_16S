...
\begin{document}
    ...
    \begin{frame}[allowframebreaks]
        ...
        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.3 \linewidth]{figures/AlphaDiversity/DADA2/evenness.png}
                &
                \includegraphics[width=0.3 \linewidth]{figures/AlphaDiversity/DADA2/faith.png}
                \\
                \mbox{(a) Evenness vector ($p < 0.01$)} & \mbox{(b) Faith PD ($p < 10^{-6}$)} \\

                \includegraphics[width=0.3 \linewidth]{figures/AlphaDiversity/DADA2/observed.png}
                &
                \includegraphics[width=0.3 \linewidth]{figures/AlphaDiversity/DADA2/shannon.png}
                \\
        ...
        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.3 \linewidth]{figures/AlphaDiversity/Deblur/evenness.png}
                &
                \includegraphics[width=0.3 \linewidth]{figures/AlphaDiversity/Deblur/faith.png}
                \\
                \mbox{(a) Evenness vector ($p < 0.05$)} & \mbox{(b) Faith PD ($p < 10^{-18}$)} \\

                \includegraphics[width=0.3 \linewidth]{figures/AlphaDiversity/Deblur/observed.png}
                &
                \includegraphics[width=0.3 \linewidth]{figures/AlphaDiversity/Deblur/shannon.png}
                \\
