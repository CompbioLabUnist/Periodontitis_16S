...
\begin{document}
    ...
    \begin{frame}[allowframebreaks]
        ...
        \begin{figure}
            \includegraphics[width=0.5 \linewidth]{figures/RandomForest/whole-DADA-silva/highest_balanced_accuracy.png}
            \caption{Random Forest Tree Plot}
        \end{figure}

        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{figures/RandomForest/whole-DADA-silva/feature_1.png}
                &
                \includegraphics[width=0.4 \linewidth]{figures/RandomForest/whole-DADA-silva/feature_2.png}
                \\
    ...
    \begin{frame}[allowframebreaks]
        ...
        \begin{figure}
            \includegraphics[width=0.8 \linewidth]{figures/RandomForest/one-DADA-gg/balanced_accuracy.png}
            \caption{Balanced Accuracy by Feature Count}
        \end{figure}

        \begin{figure}
            \includegraphics[width=0.5 \linewidth]{figures/RandomForest/one-DADA-gg/highest_balanced_accuracy.png}
            \caption{Random Forest Tree Plot}
        \end{figure}

        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{figures/RandomForest/one-DADA-gg/feature_1.png}
                &
                \includegraphics[width=0.4 \linewidth]{figures/RandomForest/one-DADA-gg/feature_2.png}
                \\
