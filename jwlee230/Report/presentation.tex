...
\begin{document}
    ...
    \begin{frame}[allowframebreaks]
        ...
        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{figures/RandomForest/DADA-silva/feature_1.png}
                &
                \includegraphics[width=0.4 \linewidth]{figures/RandomForest/DADA-silva/feature_2.png}
                \\
