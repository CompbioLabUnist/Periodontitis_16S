...
\begin{document}
   ...
   \end{frame}
    ...
    \begin{frame}[allowframebreaks]
        ...
        \begin{figure}
            \includegraphics[width=0.5 \linewidth]{figures/RandomForest/ANCOM.Deblur.homd/highest_balanced_accuracy.png}
   ...
   \end{frame}
    ...
    \begin{frame}[allowframebreaks]
        ...
        \begin{figure}
            \includegraphics[width=0.5 \linewidth]{figures/RandomForest/one-two.DADA2.silva/highest_balanced_accuracy.png}
            \caption{Random Forest Tree Plot}
        \end{figure}
