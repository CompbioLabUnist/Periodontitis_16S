...
if __name__ == "__main__":
    ...
    sample_by_stage_dict: typing.Dict[str, typing.List[str]] = {x: list() for x in step00.long_stage_order}
    ...
    figures = list()
    for base_stage in tqdm.tqdm(step00.long_stage_order):
        raw_output = list()
        ...
        seaborn.violinplot(data=output_data, x="stage", y="distance", order=step00.long_stage_order, ax=ax, inner="box", palette=step00.color_stage_dict, cut=1, linewidth=10)
