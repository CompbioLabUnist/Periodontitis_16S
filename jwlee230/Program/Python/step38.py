...
if __name__ == "__main__":
    ...
    for base_stage in tqdm.tqdm(step00.long_stage_order[1:]):
        ...
        statannotations.Annotator.Annotator(ax, list(itertools.combinations(step00.long_stage_order[1:], r=2)), data=output_data, x="stage", y="distance", order=step00.long_stage_order[1:]).configure(test="Mann-Whitney", text_format="star", loc="inside", comparisons_correction=None, verbose=True).apply_and_annotate()
